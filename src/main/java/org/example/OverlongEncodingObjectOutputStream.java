 ...
 */
public class OverlongEncodingObjectOutputStream extends ObjectOutputStream {

    public OverlongEncodingObjectOutputStream(OutputStream out) throws IOException {
        super(out);
    }
